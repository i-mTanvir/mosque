...
const posts = [
  { title: 'মসজিদ: তাকওয়া ও ঐক্যের কেন্দ্র', theme: 'ঈমান ও সমাজ', date: '১৫ আগস্ট ২০২৬', image: '/media/second-section.webp' },
  { title: 'সদকাহ জারিয়াহর মর্যাদা', theme: 'আখিরাতের প্রস্তুতি', date: '০৮ আগস্ট ২০২৬', image: '/media/goal.webp' },
  { title: 'রমজানের শিক্ষা ও আত্মশুদ্ধি', theme: 'পবিত্র মাস', date: '২৫ জুলাই ২০২৬', image: '/media/hero3.webp' },
  { title: 'আল্লাহর ঘরের মর্যাদা', theme: 'হাদিস ও শিক্ষা', date: '১১ জুলাই ২০২৬', image: '/media/hero2.webp' },
  { title: 'নামাজ: মুমিনের মেরাজ', theme: 'ইবাদত', date: '২০ জুন ২০২৬', image: '/media/hero1.webp' },
  { title: 'পরিবারে ইসলামী মূল্যবোধ', theme: 'জীবন ও সমাজ', date: '০৯ মে ২০২৬', image: '/media/hero4.webp' },
]
